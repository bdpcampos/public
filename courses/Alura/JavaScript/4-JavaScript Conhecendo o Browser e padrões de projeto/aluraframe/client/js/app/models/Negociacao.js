...
export class Negociacao {
    ...
    constructor(data, quantidade, valor) {
        this._data = new Date(data.getTime());//Programação defensiva, no construtor a propriedade já recebe uma cópia da data, assim se a variável que foi passada no construtor for alterada, não altera a propriedade.
